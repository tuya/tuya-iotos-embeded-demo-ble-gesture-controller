...
#define i2c_write   tuya_mpu6050_i2c_write
#define i2c_read    tuya_mpu6050_i2c_read
#define delay_ms    tuya_ble_device_delay_ms
#define get_ms      tuya_ble_get_ms
//#define log_i       TUYA_APP_LOG_INFO
//#define log_e       TUYA_APP_LOG_ERROR
