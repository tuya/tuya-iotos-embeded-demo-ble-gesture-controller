 ...
 * @return none
 */
STATIC VOID_T __key_gpio_init(_IN CONST TY_GPIO_PORT_E port, _IN CONST BOOL_T active_low)
{
 ...
 */
STATIC BOOL_T __get_key_stat(_IN CONST TY_GPIO_PORT_E port, _IN CONST UCHAR_T active_low)
{
    BOOL_T key_stat;
    if (active_low) {
